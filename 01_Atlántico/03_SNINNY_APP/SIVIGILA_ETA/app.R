...
# ---------- Rutas ----------
local_data_dir <- "C:/Users/Dell/Universidad de los andes/FAO-SAT - Documentos/General/06_Scripts/FAO_COLOMBIA/01_Atlántico/03_SNINNY_APP/SIVIGILA_ETA/data"
...
# *** Código por defecto para Atlántico ***
ATLANTICO_CODE <- {
          ...
          div(class="filters-grid",
              ...
              div(class="filter",
                  ...
                  selectInput(
                    ...
                    selected = ATLANTICO_CODE   # <-- por defecto ATLÁNTICO
                  )
              ),
              div(class="filter",
               ...
               div(class="card",
                   div(class="card-title",
                       ...
                       span(style="margin-left:auto;",
                            actionLink("btn_reset_e1","← Volver a Atlántico")
                       )
                   ),
