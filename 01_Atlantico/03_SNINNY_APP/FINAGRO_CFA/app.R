...
# ---------- Rutas ----------
data_dir <- "C:/Users/Dell/Universidad de los andes/FAO-SAT - Documentos/General/06_Scripts/FAO_COLOMBIA/01_Atlantico/03_SNINNY_APP/FINAGRO_CFA/data"
...
finagro_fast       <- finagro_fast %>% dplyr::filter(DEPARTAMENTO_D=="ATLÁNTICO")
